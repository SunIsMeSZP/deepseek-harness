...
flowchart TD
  ...
  subgraph group_extensions["packages/extensions"]
    ...
    pkg_tool_playwright_debug["tool-playwright-debug"]
  end
  ...
  pkg_tool_playwright_debug --> pkg_invariants
  pkg_tool_playwright_debug --> pkg_session
  pkg_tool_playwright_debug --> pkg_tools
  ...
  pkg_clock --> pkg_invariants
  pkg_clock --> pkg_llm
  pkg_clock --> pkg_tools
  pkg_weather --> pkg_invariants
  pkg_weather --> pkg_llm
  pkg_weather --> pkg_tools
  pkg_weather --> pkg_web
...
| [`tool-playwright-debug`](../packages/extensions/tool-playwright-debug) | `extensions` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`tools`](../packages/core/tools) |
...
| [`clock`](../packages/plugins/clock) | `plugins` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`tools`](../packages/core/tools) |
| [`weather`](../packages/plugins/weather) | `plugins` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`tools`](../packages/core/tools), [`web`](../packages/web/web) |
